...
# Obsługa argumentu --help
if "--help" in sys.argv or "-h" in sys.argv:
    console.print(f"[bold green]ChatGPT CLI FS Bridge[/bold green] v{__version__}")
    console.print("🚀 Secure CLI interface for ChatGPT integration with local filesystem")
    console.print()
    console.print("[bold]Usage:[/bold]")
    console.print("  gpt-shell                    Start interactive chat with ChatGPT")
    console.print("  gpt-shell --version          Show version information")
    console.print("  gpt-shell --help, -h         Show this help message")
    console.print()
    console.print("[bold]Features:[/bold]")
    console.print("  • 🔒 Secure filesystem sandbox (limited to WORKDIR)")
    console.print("  • 🛠️  6 filesystem tools: list_dir, read_file, write_file, search_text, etc.")
    console.print("  • 🤖 ChatGPT integration with function calling")
    console.print("  • 📊 Cost tracking and token usage monitoring")
    console.print("  • 🔍 RAG (Retrieval Augmented Generation) with local embeddings")
    console.print("  • 💾 Automatic file backups on modifications")
    console.print("  • 📈 Progress bars for long operations")
    console.print()
    console.print("[bold]Configuration:[/bold]")
    console.print("  Edit .env file to configure:")
    console.print("  • OPENAI_API_KEY - Your OpenAI API key (required)")
    console.print("  • OPENAI_MODEL - Model to use (default: gpt-4)")
    console.print("  • WORKDIR - Working directory (default: current)")
    console.print("  • DEBUG - Enable debug mode (0/1)")
    console.print()
    console.print("[bold]Special Commands:[/bold]")
    console.print("  /init                        Build/refresh RAG embeddings index")
    console.print("  /quit                        Exit the application")
    console.print()
    console.print("[bold]Examples:[/bold]")
    console.print("  'List all Python files'")
    console.print("  'Search for TODO comments in the project'")
    console.print("  'Create a README.md file with project description'")
    console.print("  'Analyze the code structure and suggest improvements'")
    console.print()
    console.print("For more information, visit: https://github.com/flatplanetpl/gpt-shell")
    sys.exit(0)
